...
### 1. Sysmon Configuration Verification

![Sysmon Configuration](Screenshot%202026-06-19%20122203.png)

Verified Sysmon installation and active configuration.

### 2. Event ID Analysis

![Event ID Analysis](Screenshot%202026-06-19%20123746.png)

Reviewed and analyzed Sysmon event counts using PowerShell.

### 3. DNS Query Monitoring (Event ID 22)

![DNS Query Monitoring](Screenshot%202026-06-19%20124336.png)

Captured and investigated DNS query activity generated by Windows processes.
